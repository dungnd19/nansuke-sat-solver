...
public class NansukeSolver {
	...
	private void init(){
		...
		////////
		JLabel labelTitleVar=new JLabel("Variables :");
		labelTitleVar.setSize(100, 50);
		...
		//////
		JLabel labelTitleClause=new JLabel("Clauses :");
		labelTitleClause.setSize(100, 50);
		...
		labelListNumber.setVisible(true);
